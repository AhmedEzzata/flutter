  ...
  Widget build(BuildContext context) {
    return Container(
      child: GridView.count(
        ...
        children:
            List.generate(data.length, (index) => buildProductItems(data[index])),
      ),
      color: Colors.grey,
    );
  }
...
//   database=openDatabase('todo.db',version: 1,
//   onCreate: (database,version)
//   {
//     print('database created');
//     database.execute('CREAT TABLE home(id INTEGER PRIMARY KEY, title TEXT, imge Text)').then((value) {
//       print('table created');
//     }).catchError((error){
//       print('Error when creat ${error.toString()}');
//     });
//     },
//   onOpen: (database){
...
//   });
  ...
  //
  //     'CREAT TABLE home(id INTEGER PRIMARY KEY, title TEXT, imge Text)');
//}
// Future insertdatabase() async{
//  return await database.transaction((txn) async{
//     txn.rawInsert(
//       'INSERT INTO home(title,imge) VALUES ("title","https://pisces.bbystatic.com/image2/BestBuy_US/images/products/5763/5763401cv13d.jpg")'
//     ).then((value) {
...
//   void getdata()async
//   {
//     List<Map> home= await database.rawQuary('SELECT*FROM home');
//     print(home);
//   }
